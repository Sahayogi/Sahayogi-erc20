...
function generateMerkleProofs() {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, writeFilePath, allUsers, proofs, data, jsonData, tree, root, allData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = path_1.default.join(__dirname, 'details.json');
                    writeFilePath = path_1.default.join(__dirname, 'proofs.json');
                    allUsers = [];
                    proofs = [];
                    ...
                    return [4 /*yield*/, JSON.stringify(proofs)];
                case 1:
                    allData = _a.sent();
                    fs_1.default.writeFileSync(writeFilePath, allData);
                    console.log(root);
                    return [2 /*return*/];
            }
        });
